...
=======
    sigmaDataPath = os.path.abspath(os.path.join(__file__, "../testData.xls"))
>>>>>>> 31def17f3b8f0adf03e52802d6a944323f55040d
...
=======
    historyDataPath = os.path.abspath(os.path.join(__file__, "../testData.xls"))
>>>>>>> 31def17f3b8f0adf03e52802d6a944323f55040d
